//=============================================================================
// MOG_TitlePictureCom.js タイトル編集プロジェクト
//=============================================================================

/*:
 * @plugindesc タイトル文字 ピクチャー化スクリプト
 * @author Moghunter
 *
 * @param Title Sprite
 * @desc タイトル画像の上にtitle.pngを表示するか？
 * ”Title.png”を img/titles2/ に入れてください
 * @default true
 * 
 * @param Title Sprite X-Axis
 * @desc title.pngの位置調整 X
 * @default 0
 *
 * @param Title Sprite Y-Axis
 * @desc title.pngの位置調整　Y
 * @default 0 
 * 
 * @param Cursor Visible
 * @desc カーソルの表示を行う？ true or false
 * ”Cursor.png”を img/titles2/ に入れてください
 * @default true
 *
 * @param Cursor Wave Animation
 * @desc カーソルをゆらゆら動かす？ true or false
 * @default true
 * 
 * @param Cursor X-Axis
 * @desc カーソルの位置調整 X
 ...
 * のファイルをimg/titles2/ に入れる。上下半分づつ、上未選択、下選択で作成する。
 * 
